...
# Run hdfs-cp
echo env CLASSPATH=$FULL_CLASSPATH LD_LIBRARY_PATH=$FULL_LD_LIBRARY_PATH $BASE_DIR/hdfs-cp $PARAMETER_HDFS_CMD $PARAMETER_HDFS_DIR $PARAMETER_HDFS_LIST $PARAMETER_CACHE_DIR
     env CLASSPATH=$FULL_CLASSPATH LD_LIBRARY_PATH=$FULL_LD_LIBRARY_PATH $BASE_DIR/hdfs-cp $PARAMETER_HDFS_CMD $PARAMETER_HDFS_DIR $PARAMETER_HDFS_LIST $PARAMETER_CACHE_DIR
